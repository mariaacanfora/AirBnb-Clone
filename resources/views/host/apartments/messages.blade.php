...
@section('content')
  <div class="container messages-container">
      ...
      <div class="row justify-content-center">
        ...
        @foreach($apartments as $key => $apartment)
            ...
            <div class="box-messages collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#apartment_id_{{$key+1}}" aria-expanded="false" aria-controls="apartment_id_1">
              <img class="img-profile-messages" src="{{ asset('storage/' . $apartment->cover_img) }}" alt="apartment's cover image">
    ...
    @else
      <h2>Non ci sono ancora appartamenti di cui mostrare messaggi...</h2>
    @endif
  </div>
@endsection